...
flags_fortran='-march=core-avx2 -i4 -r8 -O3 -fp-model strict -fno-alias -cpp'
#flags_fortran=''
...
#flags_fortran="-DMPI=OFF -DMPI_INCLUDE=OFF $flags_fortran"
